...
export class ProductComponent implements OnInit {
  ...
  private currentId;
	private errorMessage;
          ...
          isOnSale = new FormControl("", Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: "org.acme.model.Product",
          ...
          "isOnSale":this.isOnSale.value,
        
      
        
          "isBlocked":this.isBlocked.value,
    ...
    .then((result) => {
      ...
      let formObject = {
        ...
        if(result.isOnSale){
            ...
            formObject.isOnSale = result.isOnSale;
          
        }else{
          formObject.isOnSale = null;
        }
      
        if(result.isBlocked){
          
            formObject.isBlocked = result.isBlocked;
          
        }else{
          formObject.isBlocked = null;
        }
