...
describe('Starting tests for angular-app', function() {
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Person table should have 3 columns',() => {
      page.navigateTo('/Person');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Bank table should have 2 columns',() => {
      page.navigateTo('/Bank');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('setProductToSale component should be loadable',() => {
      page.navigateTo('/setProductToSale');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('setProductToSale');
      });
    });
